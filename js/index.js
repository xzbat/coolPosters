$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫前端，是计算机技术中最流行的一个大类</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我的主要工作是解决用户的交互体验，让用户面对的是好看的界面，而不是黑框框下的代码</div>",2000);
	...
	c.load("<div class='code writecode'>&nbsp;<span class='key'>max-height</span>: <span class='value'>94.5%</span>;</div>");
  	...
  	c.load("<div class='code writecode'>}</div></p>");
  	c.load("<p><div class='comment writecode'>/**</div>");
	c.load("<div class='comment writecode'>&nbsp;*现在我们差不多可以开始正式的自我介绍了</div>");
	...
	w.load("<p><div class='writecode'>前端</div>");
	w.load("<div class='writecode'>诞生于浏览器的出现</div>");
	w.load("<div class='writecode'>隶属于web开发</div></p>");
	w.load("<h1 class='writecode'>兴起于移动端（就是你现在看我用的小手机）的普及</h1>");
	// w.load("<ul>");
	...
	w.load("<ul>");
	w.load("<li class='writecode'>让网站后台冷冰冰的数据变得可见而且可爱</li>");
	w.load("<li class='writecode'>结合腾讯微信的api，做个小程序</li>");
	w.load("<li class='writecode'>通过SPA单页面应用，用cordova打个包做成安卓APP</li>");
	w.load("<li class='writecode'>用JavaScript爬虫看看教务系统小学妹或者大学姐的照片</li>");
	w.load("<li class='writecode'>做个动态的酷炫简历，像我现在所做的一样</li>");
	...
	// w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
	c.load("<div class='comment writecode'>&nbsp;*左面的介绍看起来不是太令人满意，让我们先给他来点动态渲染</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='comment writecode'>&nbsp;*.</div>");
	c.load("<div class='comment writecode'>&nbsp;*</div>");
	c.load("<div class='comment writecode'>&nbsp;*差不多了，让我们的介绍动起来！</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='comment writecode'>&nbsp;*对了,FCC和前端有什么关系?</div>");
	c.load("<div class='comment writecode'>&nbsp;*FCC是学习前端的最快途径啊</div>");
	c.load("<div class='comment writecode'>&nbsp;*要来嘛？</div>");
	c.load("<div class='comment writecode'>&nbsp;*扫个码啊！</div>");
	c.load("<div class='comment writecode'>&nbsp;*最后非常感谢您愿意花3分钟看完我的介绍！</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
